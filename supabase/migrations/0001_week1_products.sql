-- Week 1 — Products (Relational Foundations)
-- Goal: model your first real entity. A storefront needs something to sell.
--
-- Create a `products` table with the columns below, then seed at least three
-- products. The homepage will render every row as a product card.
--
-- Required columns:
--   id           uuid, primary key, auto-generated
--   name         text, required
--   description  text, required
--   price        money amount, must be >= 0
--   stock_count  whole number of units on hand, must be >= 0
