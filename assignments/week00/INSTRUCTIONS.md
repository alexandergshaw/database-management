...
Make a free **Supabase** project — this is your database.
**Video:** [Getting started with Supabase](https://www.youtube.com/watch?v=i_bPeTZVlg0)

### 2) Connect it to the website
Import this repo into **Vercel** and add the `SUPABASE_DB_URL` value (find it in
Supabase → Project Settings → Database → Connection string). That's what lets the
website read your database.
**Video:** [Deploy a Next.js app to Vercel from GitHub](https://www.youtube.com/watch?v=MoQ6g3pmXtA) · [Find your Supabase connection string](https://www.youtube.com/watch?v=LzOdTIZOnaM)
...
is one record. You add rows with an **INSERT**. Here's the shape using a simple
example (a list of pets) so you can see how it looks — yours will be about your
catalog:
...
create table pets (
  ...
  name text not null,                              -- text that must be filled in
...
## Watch & learn (general SQL)
- **Video:** [SQL Tutorial – Full Course for Beginners (freeCodeCamp)](https://www.youtube.com/watch?v=HXV3zeQKqGY) — bookmark this; it covers most of the semester.
