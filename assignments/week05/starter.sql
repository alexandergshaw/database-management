-- Week 5 — Normalization. Fix three denormalized tables — one per normal form.
...
-- Problem 2 — instrument names depend only on the instrument code. Create
-- instruments(code primary key, instrument_name) and probe_instruments(probe_no,
-- instrument_code references instruments, readings, primary key (probe_no,
-- instrument_code)); add rows.
-- TODO:
